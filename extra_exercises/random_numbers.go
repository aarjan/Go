// Sample program to show uses of math/rand package to generate pseudorandom numbers.
...
func main() {
	...
	// To produce varying sequences, give it a seed that changes. Note that this is not safe to use for random numbers you intend to be secret, use crypto/rand for those.
...
// OR, you can seed your random number generator with the current time.
